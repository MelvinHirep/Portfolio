...
<header id="home" class="flex justify-between items-center p-6 relative">
    <h1 class="text-3xl font-bold">Mon Portfolio</h1>
    <nav class="fixed top-0 right-0 w-full bg-transparent z-50">
        <ul class="flex space-x-4 justify-end p-0 m-0">
            <li><a href="#home" class="text-white hover:text-blue-400">Accueil</a></li>
            <li><a href="#projects" class="text-white hover:text-blue-400">Projets</a></li>
            <li><a href="#contact" class="text-white hover:text-blue-400">Contact</a></li>
        </ul>
    </nav>
    ...
    <main class="relative flex flex-col items-center justify-center h-screen text-center">
        <div class="absolute top-16 left-4 md:left-10 text-left space-y-6 text-xl w-64">
            ...
            <div class="flex flex-col items-center space-y-16 mt-40 text-4xl w-full">
    <a href="assets/CV-Melvin-HIREP.pdf" download target="_blank" class="relative inline-block">
        <div class="w-12 h-12 bg-white text-black rounded-full flex items-center justify-center text-lg font-bold shadow-md">
            CV
        </div>
    </a>

    <a href="https://www.linkedin.com/in/melvin-hirep-459490241" target="_blank" class="text-white hover:text-blue-400">
        <i class="fab fa-linkedin"></i>
    </a>

    <a href="https://github.com/MelvinHirep" target="_blank" class="text-white hover:text-blue-400">
        <i class="fab fa-github"></i>
    </a>

    <button onclick="alert('07 83 89 76 21')" class="text-white hover:text-blue-400">
...
<!-- ... reste du code inchangé ... -->
        ...
        <div class="container mx-auto text-center">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
                <div class="project-card appear relative group overflow-hidden bg-gray-700 p-6 rounded-lg shadow-lg hover:scale-105 hover:bg-gray-600 transition-transform duration-300">
                    ...
                    <p class="mt-2 text-gray-300">Jeu du Puissance 4 réalisé en Python avec interface simple et logique de jeu complète.</p>
                </div>
                <div class="project-card appear relative group overflow-hidden bg-gray-700 p-6 rounded-lg shadow-lg hover:scale-105 hover:bg-gray-600 transition-transform duration-300">
                    <h3 class="text-xl font-semibold mb-2">Twitter</h3>
                    <img src="assets/Capture d’écran du 2025-03-30 13-23-07.png" alt=" " class="w-full h-48 object-cover cursor-pointer" data-video="assets/Capture vidéo du 30-03-2025 13:16:54.webm">
                    <p class="mt-2 text-gray-300">Une application web en PHP permettant la gestion d’un planning collaboratif.</p>
                </div>
                <div class="project-card appear relative group overflow-hidden bg-gray-700 p-6 rounded-lg shadow-lg hover:scale-105 hover:bg-gray-600 transition-transform duration-300">
                    <h3 class="text-xl font-semibold mb-2">Maquette</h3>
                    <img src="assets/Capture d’écran du 2025-03-30 13-33-49.png" alt=" " class="w-full h-48 object-cover cursor-pointer" data-video="assets/Capture vidéo du 30-03-2025 13:34:55.webm">
                    <p class="mt-2 text-gray-300">Site de recettes interactif avec filtres par ingrédients, développé en HTML/CSS/JS.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="contact" class="py-16 bg-gray-900">
        <div class="container mx-auto px-4 max-w-xl">
            <h2 class="text-4xl font-bold mb-6 text-center">Me contacter</h2>
            <div id="form-message" class="hidden mb-4 p-4 rounded-lg text-center"></div>
            <form id="contact-form" action="contact.php" method="POST" class="space-y-6">
                <input type="text" name="nom" placeholder="Nom" required class="w-full p-3 rounded bg-gray-800 text-white border border-gray-700">
                <input type="email" name="email" placeholder="Adresse email" required class="w-full p-3 rounded bg-gray-800 text-white border border-gray-700">
                <textarea name="message" rows="5" placeholder="Votre message" required class="w-full p-3 rounded bg-gray-800 text-white border border-gray-700"></textarea>
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded-lg">Envoyer</button>
            </form>
        </div>
    </section>
